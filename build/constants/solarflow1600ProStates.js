...
var solarflow1600ProStates_exports = {};
__export(solarflow1600ProStates_exports, {
  solarflow1600AcPlusStates: () => solarflow1600AcPlusStates
});
module.exports = __toCommonJS(solarflow1600ProStates_exports);
var import_sharedStates = require("./sharedStates");
const solarflow1600AcPlusStates = import_sharedStates.sharedStates.concat(
  [
    {
      title: "hyperTmp",
      nameDe: "Temperatur des Solarflow 1600 AC Plus",
      nameEn: "Temperature of Solarflow 1600 AC Plus",
      type: "number",
...
0 && (module.exports = {
  solarflow1600AcPlusStates
});
//# sourceMappingURL=solarflow1600ProStates.js.map
