import { solarflow4000MixAcPlusControlStates } from "../../constants/controlStates/solarflow4000MixAcPlusControlStates";
...
export class Sf4000MixAcPlus extends ZenSdkIobDevice {
  maxInputLimit = 4000;
  maxOutputLimit = 4000;
  ...
  controlStates = [...sharedControlStates, ...solarflow4000MixAcPlusControlStates];
