import { ac2400PlusControlStates } from "../../constants/ac2400PlusControlStates";
import { ac2400PlusStates } from "../../constants/ac2400PlusStates";
...
export class Sf2400AcPlus extends ZenIobDevice {
  maxInputLimit = 2400;
  maxOutputLimit = 2400;

  states = ac2400PlusStates;
